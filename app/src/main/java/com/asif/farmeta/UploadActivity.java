...
public class UploadActivity extends AppCompatActivity {
    ...
    EditText firstName, lastName, editCropName, editQuantity, editContact, editAddress, editPrice;
    Spinner spinnerType;
    ...
    String UPLOAD_URL = "http://192.168.1.102/farmeta_api/upload_crops.php";
